...
// document.getElementById("id") return type is HTML collection
...
// document.querySelector("id/class/tag")    in this to get id we use (#) , to get class use (.) // return nodeList
